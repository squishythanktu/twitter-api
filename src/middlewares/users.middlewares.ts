...
const confirmPasswordSchema: ParamSchema = {
  ...
  custom: {
    options: (value, { req }) => {
      if (value !== req.body.password) throw new Error(USERS_MESSAGES.CONFIRM_PASSWORD_MUST_BE_THE_SAME_AS_PASSWORD)
      return true
    }
  }
}
      ...
      email: {
        ...
        custom: {
          options: async (value) => {
            ...
            if (isEmailExist) throw new Error(USERS_MESSAGES.EMAIL_ALREADY_EXISTS)
            return true
          }
        }
      },
